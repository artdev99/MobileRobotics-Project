...
class camera_class:
    def __init__(self, thresh_obstacle, thresh_goal):
        ...
        cv2.imshow("Yellow",frame1)
        cv2.waitKey(1)
        cv2.imwrite("Yellow.png",frame1)
        # Warmup
        ...
        cv2.imshow("Imagebeforecorrection",self.image)
        cv2.waitKey(1)
        cv2.imwrite("Imagebeforecorrection.png",self.image)
        ...
        cv2.imshow("Imageaftercorrection",self.persp_image)
        cv2.waitKey(1)
        cv2.imwrite("Imageaftercorrection.png",self.persp_image)
        ...
        if self.corners_found:
            ...
            cv2.imshow("thresholded image",self.thresholded_image)
            cv2.waitKey(1)
            cv2.imwrite("thresholded image.png",self.thresholded_image)
        else:
            self.cam.release()
...
def full_detection_cnt_centroid(
    ...
    cv2.waitKey(1)
    cv2.imwrite("distance image.png",distance)
    ...
    cv2.imshow("goal mask0",goal_mask)
    cv2.waitKey(1)
    cv2.imwrite("goal mask0.png",goal_mask)
    ...
    cv2.waitKey(1)
    cv2.imwrite("goal mask.png",goal_mask)
